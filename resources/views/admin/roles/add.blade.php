                                ...
                                <div class="row" style="">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" /> {{ notifyError($errors,'name') }}
                                        </div>
                                        <div class="form-group">
                                            <label><span style="color:black">Mô tả</label>
                                            <textarea name="display_name" style="width: 100%;height: 100px;"></textarea> {{ notifyError($errors,'display_name') }}
                                        </div>
                                    </div>
                                </div>
                                <!-- permisssion -->
                                ...
                                <div class="check primary mb-3 col-md-12 addPer " >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="text-primary col-md-3 bottom">
                                            <label>
                                                <input type="checkbox" value="{{ $permissionsChildrentsItem->id }}" name="permission_id[]" class="checkbox_childrent">
